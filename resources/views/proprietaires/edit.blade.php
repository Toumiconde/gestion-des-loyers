        ...
        <div class="grid grid-cols-1 gap-6">
            ...
            <div>
                ...
                <input type="text" name="name"
                       value="{{ old('name', $proprietaire->user->name) }}"
            ...
            <div>
                ...
                <textarea name="adresse" rows="2"
                          class="w-full border rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500">{{ old('adresse', $proprietaire->adresse) }}</textarea>
            </div>

            <div>
                <label class="block text-sm font-medium text-gray-700 mb-1">RIB Bancaire</label>
                <input type="text" name="rib_bancaire"
                       value="{{ old('rib_bancaire', $proprietaire->rib_bancaire) }}"
